                                        ...
                                        <div className="space-y-2">
                                            {runResult.steps.map((stepResult, index) => (
                                                <div
                                                    ...
                                                    className={`flex items-center gap-3 p-3 rounded-lg border ${stepResult.status === "SUCCESS" || stepResult.status === "COMPLETED"
                                                ...
                                                >
                                                    ...
                                                    <span className={`text-xs font-medium ${stepResult.status === "SUCCESS" || stepResult.status === "COMPLETED"
                                                            ? "text-green-400"
                                                            : stepResult.status === "FAILED"
                                                                ? "text-red-400"
                                                                : "text-yellow-400"
