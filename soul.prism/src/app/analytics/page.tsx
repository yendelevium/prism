    ...
    return (
      <div className="min-h-screen bg-[#2E3440] p-4 sm:p-6 flex items-center justify-center">
        <div className="bg-[#3B4252] border border-[#4C566A] rounded-lg shadow-xl p-6 sm:p-8 max-w-md w-full">
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-[#ECEFF4] text-center mb-2">
            Error Loading Analytics
          </h2>
          <p className="text-sm sm:text-base text-[#D8DEE9] text-center mb-4">
            {error}
          </p>
          <button
    ...
    <div className="min-h-screen bg-[#2E3440] p-3 sm:p-4 lg:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8 flex flex-col sm:flex-row justify-between items-start gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#ECEFF4] mb-1 sm:mb-2">
              Analytics Dashboard
            </h1>
            <p className="text-xs sm:text-sm text-[#D8DEE9]">
              Real-time API performance and tracing insights
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <RefreshCw
                className={`w-4 h-4 sm:w-5 sm:h-5 text-[#ECEFF4] ${loading ? "animate-spin" : ""}`}
              />
            </button>
          </div>
        </div>
        ...
        {loading && !analyticsData.summary.totalRequests ? (
          <div className="flex items-center justify-center py-16 sm:py-20">
            <div className="text-center">
              ...
              <p className="text-sm sm:text-base text-[#D8DEE9]">
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8">
              <SummaryCard
                ...
                value={
                  analyticsData.summary.totalRequests?.toLocaleString() || "0"
                }
                bgColor="bg-[#88C0D0]"
              />
              <SummaryCard
            ...
            <div className="bg-[#3B4252] border border-[#4C566A] rounded-lg p-4 sm:p-5 lg:p-6 mb-4 sm:mb-6">
              <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-[#ECEFF4] mb-3 sm:mb-4">
                Request Volume
              </h2>
              {analyticsData.requestVolume.length > 0 ? (
                <ResponsiveContainer width="100%" height={250}>
                  <LineChart data={analyticsData.requestVolume}>
                    ...
                    <Legend
                      wrapperStyle={{ color: "#D8DEE9", fontSize: "12px" }}
                    />
                    <Line
                      type="monotone"
                      dataKey="requests"
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-[#4C566A]">
                        <th className="text-left py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-[#D8DEE9]">
                          Endpoint
                        </th>
                        <th className="text-right py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-[#D8DEE9]">
                          Calls
                        </th>
                        <th className="text-right py-2 sm:py-3 px-2 sm:px-4 text-xs sm:text-sm font-semibold text-[#D8DEE9]">
                          Avg Time
                      ...
                      {analyticsData.endpoints.map((endpoint, index) => (
                        ...
                        >
                          ...
                          <td className="text-right py-2 sm:py-3 px-2 sm:px-4">
                            <span
                              className={`text-xs sm:text-sm font-medium ${endpoint.avg_time > 300 ? "text-[#BF616A]" : "text-[#A3BE8C]"}`}
                            >
                          ...
                          <td className="text-right py-2 sm:py-3 px-2 sm:px-4">
                            <span
                              className={`text-xs sm:text-sm ${endpoint.errors > 20 ? "text-[#BF616A] font-semibold" : "text-[#ECEFF4]"}`}
                            >
                              {endpoint.errors}
                            </span>
                          </td>
            ...
            <div className="bg-[#3B4252] border border-[#4C566A] rounded-lg p-4 sm:p-5 lg:p-6">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-[#ECEFF4]">
                  Recent Errors
                </h2>
                  ...
                  {analyticsData.recentErrors.map((error) => (
                    ...
                    >
                      <div className="flex-1 w-full">
                        ...
                        <p className="text-xs sm:text-sm text-[#EBCB8B] font-medium">
                          {error.error}
                        </p>
                      </div>
