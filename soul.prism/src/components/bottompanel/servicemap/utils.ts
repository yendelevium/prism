...
import type { ServiceMapData, ServiceNode, ServiceEdge, ServiceMetrics } from './types';
 ...
 */
export function buildServiceGraph(spans: Span[], addTestNodes = false): ServiceMapData {
