                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 rounded-md bg-[var(--bg-panel)] border text-[var(--text-primary)] placeholder-[var(--text-secondary)] focus:outline-none focus:border-[var(--accent)] ${errors.name ? "border-[var(--error)]" : "border-[var(--border-color)]"
                                        }`}
                                />
                                {errors.name && (
