              ...
              <div className="p-3.5 space-y-2">
                {chaosRules.map((rule, i) => (
                  ...
                  >
                    ...
                    <div
                      className={`w-2 h-2 rounded-full flex-shrink-0 ${rule.status === "active" ? "bg-primary animate-pulse-glow" : "bg-muted-foreground/30"}`}
                    />
                  </motion.div>
                ))}
              </div>
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-4">
              ...
              <span className="text-muted-foreground">
                Fix them before users notice.
              </span>
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-5">
              Inject latency, force 500 errors, drop connections, and run
              concurrent load tests — all tagged in traces so you know what's
              real and what's simulated.
            </p>
