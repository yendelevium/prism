...
// @Success      200 {object} model.RestResponse "Successful response with tracing info"
// @Failure      400 {object} model.RestResponse "Invalid request body"
// @Failure      500 {object} model.RestResponse "Request execution failed"
// @Router       /rest/ [post]
